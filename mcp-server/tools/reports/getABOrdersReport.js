/**
 * Get AB Activity Orders Report
 * Get orders report data for an A/B Test activity
 */
import { makeTargetRequest } from '../../helpers/makeTargetRequest.js';

export const tool = {
  name: 'getABOrdersReport',
  description: 'Get orders report data for an A/B Test activity, including conversion metrics and order information',
  inputSchema: {
    type: 'object',
    properties: {
      id: {
...
export async function handler(args, context) {
  ...
  let path = `/target/activities/ab/${args.id}/report/orders`;
