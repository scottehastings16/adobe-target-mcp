/**
 * Get XT Activity Performance Report
 * Get performance report for an Experience Targeting activity
 */
import { makeTargetRequest } from '../../helpers/makeTargetRequest.js';

export const tool = {
  name: 'getXTPerformanceReport',
  description: 'Get performance report for an Experience Targeting (XT) activity with metrics, conversions, and visitor data',
  inputSchema: {
    type: 'object',
    properties: {
      id: {
...
export async function handler(args, context) {
  ...
  let path = `/target/activities/xt/${args.id}/report/performance`;
